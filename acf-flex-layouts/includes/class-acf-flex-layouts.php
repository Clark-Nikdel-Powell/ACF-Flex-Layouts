 ...
 * @subpackage ACF_Flex_Layouts/includes
 */
...
class ACF_Flex_Layouts {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      ACF_Flex_Layouts_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - ACF_Flex_Layouts_Loader. Orchestrates the hooks of the plugin.
	 * - ACF_Flex_Layouts_i18n. Defines internationalization functionality.
	 * - ACF_Flex_Layouts_Admin. Defines all hooks for the admin area.
	 * - ACF_Flex_Layouts_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-acf-flex-layouts-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-acf-flex-layouts-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-acf-flex-layouts-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-acf-flex-layouts-public.php';

		$this->loader = new ACF_Flex_Layouts_Loader();
	 ...
	 *
	 * Uses the ACF_Flex_Layouts_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new ACF_Flex_Layouts_i18n();
	...
	private function define_public_hooks() {
		...
		$this->loader->add_action( 'init', $plugin_public, 'add_pattern_library_atoms_and_organisms', 20 );
	 ...
	 *
	 * @since     1.0.0
	 * @return    ACF_Flex_Layouts_Loader    Orchestrates the hooks of the plugin.
	 */
